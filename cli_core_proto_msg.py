...
class Fk(Enum32):
	...
	nameDict = {
			...
			FK_VRKF8: "FK_VRKF8",
			FK_VPU1F9: "FK_VPU1F9",
			FK_VPU2F10: "FK_VPU2F10",
			FK_VPU3F11: "FK_VPU3F11",
			FK_OPUF12: "FK_OPUF12",
	}
...
class AnalogTmiInd(Msg):
	def __init__(self, VIPVKLT1=Uint8(0), VIPKZT2=Uint8(0), VIPPNT3=Uint8(0), STR1VKLT4=Uint8(0), STR1KZT5=Uint8(0), STR1PNT6=Uint8(0), STR2VKLT7=Uint8(0), STR2KZT8=Uint8(0), STR2PNT9=Uint8(0), PU1VKLT10=Uint8(0), PU2VKLT11=Uint8(0), PU3VKLT12=Uint8(0), OMB1T13=Uint8(0), OMB2T14=Uint8(0), OMBVKLT15=Uint8(0), BE1VKLT16=Uint8(0), BE2VKLT17=Uint8(0), BE3VKLT18=Uint8(0), DTBI1T19=Uint32(0), DTBI2T20=Uint32(0), DTBI3T21=Uint32(0), DTBI4T22=Uint32(0), DTBS1T23=Uint32(0), DTBS2T24=Uint32(0), DTK1T25=Uint32(0), DTK2T26=Uint32(0), DTR1T27=Uint32(0), DTR2T28=Uint32(0), DTKT29=Uint32(0)):
		Msg.__init__(self, name = "Analog telemetry indication", id = Hex32(0x3040001))
		Msg.addField(self, fieldName = "VIPVKLT1", fieldType = Uint8, field = VIPVKLT1)
		Msg.addField(self, fieldName = "VIPKZT2", fieldType = Uint8, field = VIPKZT2)
		Msg.addField(self, fieldName = "VIPPNT3", fieldType = Uint8, field = VIPPNT3)
		Msg.addField(self, fieldName = "STR1VKLT4", fieldType = Uint8, field = STR1VKLT4)
		Msg.addField(self, fieldName = "STR1KZT5", fieldType = Uint8, field = STR1KZT5)
		Msg.addField(self, fieldName = "STR1PNT6", fieldType = Uint8, field = STR1PNT6)
		Msg.addField(self, fieldName = "STR2VKLT7", fieldType = Uint8, field = STR2VKLT7)
		Msg.addField(self, fieldName = "STR2KZT8", fieldType = Uint8, field = STR2KZT8)
		Msg.addField(self, fieldName = "STR2PNT9", fieldType = Uint8, field = STR2PNT9)
		Msg.addField(self, fieldName = "PU1VKLT10", fieldType = Uint8, field = PU1VKLT10)
		Msg.addField(self, fieldName = "PU2VKLT11", fieldType = Uint8, field = PU2VKLT11)
		Msg.addField(self, fieldName = "PU3VKLT12", fieldType = Uint8, field = PU3VKLT12)
		Msg.addField(self, fieldName = "OMB1T13", fieldType = Uint8, field = OMB1T13)
		Msg.addField(self, fieldName = "OMB2T14", fieldType = Uint8, field = OMB2T14)
		Msg.addField(self, fieldName = "OMBVKLT15", fieldType = Uint8, field = OMBVKLT15)
		Msg.addField(self, fieldName = "BE1VKLT16", fieldType = Uint8, field = BE1VKLT16)
		Msg.addField(self, fieldName = "BE2VKLT17", fieldType = Uint8, field = BE2VKLT17)
		Msg.addField(self, fieldName = "BE3VKLT18", fieldType = Uint8, field = BE3VKLT18)
		Msg.addField(self, fieldName = "DTBI1T19", fieldType = Uint32, field = DTBI1T19)
		Msg.addField(self, fieldName = "DTBI2T20", fieldType = Uint32, field = DTBI2T20)
		Msg.addField(self, fieldName = "DTBI3T21", fieldType = Uint32, field = DTBI3T21)
		Msg.addField(self, fieldName = "DTBI4T22", fieldType = Uint32, field = DTBI4T22)
		Msg.addField(self, fieldName = "DTBS1T23", fieldType = Uint32, field = DTBS1T23)
		Msg.addField(self, fieldName = "DTBS2T24", fieldType = Uint32, field = DTBS2T24)
		Msg.addField(self, fieldName = "DTK1T25", fieldType = Uint32, field = DTK1T25)
		Msg.addField(self, fieldName = "DTK2T26", fieldType = Uint32, field = DTK2T26)
		Msg.addField(self, fieldName = "DTR1T27", fieldType = Uint32, field = DTR1T27)
		Msg.addField(self, fieldName = "DTR2T28", fieldType = Uint32, field = DTR2T28)
		Msg.addField(self, fieldName = "DTKT29", fieldType = Uint32, field = DTKT29)
